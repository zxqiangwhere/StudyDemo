...
namespace HPSocketLibs.ServerComponents
{
    ...
    public class TcpServer : ITcpServer
    {
        ...
        public uint AcceptSocketCount
        {
            get
            {
                return SdkFunctions.HP_TcpServer_GetAcceptSocketCount(pServer);
            }
            set
            {
                SdkFunctions.HP_TcpServer_SetAcceptSocketCount(pServer, value);
            }
        }
        ...
        public uint SocketBufferSize
        {
            get
            {
                return SdkFunctions.HP_TcpServer_GetSocketBufferSize(pServer);
            }
            set
            {
                SdkFunctions.HP_TcpServer_SetSocketBufferSize(pServer, value);
            }
        }
        ...
        public uint SocketListenQueue
        {
            get
            {
                return SdkFunctions.HP_TcpServer_GetSocketListenQueue(pServer);
            }
            set
            {
                SdkFunctions.HP_TcpServer_SetSocketListenQueue(pServer, value);
            }
        }
        ...
        public uint KeepAliveTime
        {
            get
            {
                return SdkFunctions.HP_TcpServer_GetKeepAliveTime(pServer);
            }
            set
            {
                SdkFunctions.HP_TcpServer_SetKeepAliveTime(pServer, value);
            }
        }
        ...
        public uint KeepAliveInterval
        {
            get
            {
                return SdkFunctions.HP_TcpServer_GetKeepAliveInterval(pServer);
            }
            set
            {
                SdkFunctions.HP_TcpServer_SetKeepAliveInterval(pServer, value);
            }
        }
        ...
        protected virtual bool CreateListener()
        {
            ...
            pListener = SdkFunctions.Create_HP_TcpServerListener();
            if (pListener == IntPtr.Zero)
            {
                return false;
            }
            pServer = SdkFunctions.Create_HP_TcpServer(pListener);
            if (pServer == IntPtr.Zero)
            {
                return false;
            }
        ...
        public virtual void Destroy()
        {
            ...
            if (pServer != IntPtr.Zero)
            {
                SdkFunctions.Destroy_HP_TcpServer(pServer);
                pServer = IntPtr.Zero;
            }
            if (pListener != IntPtr.Zero)
            {
                SdkFunctions.Destroy_HP_TcpServerListener(pListener);
        ...
        public bool SendSmallFile(IntPtr connId, string lpszFileName, ref WSABUF pHead, ref WSABUF pTail)
        {
            return SdkFunctions.HP_TcpServer_SendSmallFile(pServer, connId, lpszFileName, ref pHead, ref pTail);
        }
