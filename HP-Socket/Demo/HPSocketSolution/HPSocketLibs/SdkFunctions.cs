...
namespace HPSocketLibs
{
    public class SdkFunctions
    {
        ...
        #region TCP Pack Server 操作方法

        #endregion

        #region TCP Pack Server属性访问方法
